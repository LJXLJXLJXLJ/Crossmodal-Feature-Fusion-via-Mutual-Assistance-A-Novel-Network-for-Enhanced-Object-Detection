...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/mnt/cd/ljx/xiaofuwuqi/runs/train/exp112/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/mnt/cd/ljx/m3fd/visible/test/images', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/mnt/cd/ljx/m3fd/infrared/test/images', help='source')  # file/folder, 0 for webcam
