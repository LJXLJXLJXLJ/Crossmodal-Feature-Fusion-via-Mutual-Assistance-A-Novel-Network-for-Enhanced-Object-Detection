...
#     else:
#         return iou  # IoU
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, Focal=False, alpha=1, gamma=0.5,beta=0.25, eps=1e-7):
    # Returns Intersection over Union (IoU) of box1(1,4) to box2(n,4)
    ...
    if CIoU or DIoU or GIoU or EIoU or SIoU:
        ...
        if CIoU or DIoU or EIoU or SIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            if CIoU:  # https://github.com/Zzh-tju/DIoU-SSD-pytorch/blob/master/utils/box/box_utils.py#L47
                ...
                balanced_weight = beta * focal_weight + (1 - beta) * (1 - focal_weight)

                # 计算最终的 Varifocal-EIoU 损失
                varifocal_eiou = eiou*balanced_weight
                # varifocal_eiou = eiou + balanced_weight
                return varifocal_eiou
